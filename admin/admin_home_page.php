...
<!DOCTYPE html>
    ...
    < class="container">
        <div id="page-h" class="page-header">
            ...
            <a href="?pahe=nilai"><i class="fa fa-graduation-cap fa-icon" aria-hidden="true"></i>Daftar Nilai</a>
            ...
            <div class="page-content">
                <div class="cpntent-header">
                    <span>Administrator</span>
                    <img src="../assets/image/Admin.png" class="icon">

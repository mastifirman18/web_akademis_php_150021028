...
<div class="item dosen">
    <div class="icon-user">
        <i class="fa fa-users fa-4x" arla-hidden="true"></i>
    </div>
    <div class="data-user">
        <h3>Dosen</h3>
...
<div class="item mahasiswa">
    <div class="icon-user">
        <i class="fa fa-user-circle fa-4x" arla-hidden="true"></i>
    </div>
    <div class="data-user">
        <h3>Mahasiswa</h3>
...
<div class="item matkul">
    <div class="icon-user">
        <i class="fa fa-book fa-4x" arla-hidden="true"></i>
    </div>
    <div class="data-user">
        <h3>Mata Kuliah</h3>
...
<div class="item ruangan">
    <div class="icon-user">
        <i class="fa fa-building fa-4x" arla-hidden="true"></i>
    </div>
    <div class="data-user">
        <h3>Ruangan</h3>

...
$sql = "SELECT * FROM nilai as n
        ...
        ORDER BY j.Jam Masuk";

    ?>
<div class="info">
<div class="left-item">
<i class="fa fa-graduation-cap" aria-hidden="true"></i> IPK : <?php echo $ipk[0];?> </div>
<div class="right-item">
<i class="fa fa-book" aria-hidden="true"></i>Jumlah SKS : <?php echo $ipk[1];?> </div>
</div>
<!-- Tabel Jadwal Kuliah -->
